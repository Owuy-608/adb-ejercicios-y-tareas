...
-- 8. Devuelve un listado con el código de cliente de aquellos clientes que realizaron algún pago en 2008. Elimina códigos repetidos. Resuelve la consulta:
...
FROM 
  pago
WHERE 
  fecha_pago BETWEEN '2008-01-01' AND '2008-12-31';
...
FROM 
  pedido
WHERE 
  ADDDATE(fecha_entrega, 2) = fecha_esperada;
